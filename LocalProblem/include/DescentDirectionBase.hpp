 ...
 */
    ...
    public:
         ...
         */
        virtual apsc::LineSearch::Traits<PRDIM>::Vector
        operator()(apsc::OptimizationCurrentValues<PRDIM> const &values) = 0;
...
#endif /* EXAMPLES_SRC_LINESEARCH_DESCENTDIRECTIONBASE_HPP_ */
